...
const TEAM = [
  ...
  { name: "Harry", role: "Éducateur sportif & Formateur", highlights: ["Cursus STAPS", "Multi-sport", "Coaching terrain"], bio: "Passé par le cursus STAPS, Harry a trouvé sa vocation dans le coaching et l'accompagnement client. Son approche multi-sport en fait un atout de taille dans l'équipe.", featured: false, photo: "/images/harry.png" },
  ...
  { name: "Johanna", role: "Diététicienne-nutritionniste du sport & Formatrice", highlights: ["Diététicienne-nutritionniste", "Spécialiste nutrition du sport", "Musculation & sports d'endurance"], bio: "Diététicienne-nutritionniste spécialisée en nutrition du sport. En charge du volet nutrition appliquée à la musculation pour les élèves FMCS.", featured: false, photo: "/images/johanna.jpg" },
];
